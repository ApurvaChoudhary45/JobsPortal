...
const Search = () => {
  ...
  <motion.div className="flex w-full max-w-4xl mx-auto" variants={container(1.5) } initial="hidden" animate="show">
    <input
      ...
      className="w-full px-4 py-2 border border-black-300 rounded-l-md focus:outline-none focus:ring-2 text-black focus:ring-blue-500" onChange={(e)=>setInput(e.target.value)} value={Input}
    />
    <button
